...
$qury= "SELECT * FROM Alumni2 WHERE rollNo = '$rollNo'";
$result1=mysqli_query($conn,$qury);
$num_rows = mysqli_num_rows($result1);
if($num_rows>0)
{
// update the form data into the database
$sql = "UPDATE Alumni2 SET companyName='$companyName', role='$role', package='$package', year='$year' WHERE rollNo='$rollNo';";
...
{
// update the form data into the database
$sql = "INSERT into Alumni2 (rollNo, companyName,role,package,year) values('$rollNo','$companyName', '$role', '$package', '$year' );";
